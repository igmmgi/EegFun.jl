...
include("analysis/combine_channels.jl")
include("analysis/combine_conditions.jl")
include("analysis/difference_conditions.jl")
...
include("analysis/mirror_data.jl")
...
include("plots/plot_epoch_rejection.jl")
