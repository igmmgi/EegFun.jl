...
function plot_trigger_timing(dat::ContinuousData; kwargs...)
    ...
    start_time = trigger_times[1]
    end_time = trigger_times[end]
    ...
    initial_position = max(0.0, start_time - 10.0)  # Start 10 seconds before first trigger or at 0
