...
"""
function repair_bad_channels!(data::AbstractMatrix, bad_channels::Vector{Symbol}, channels::Vector{Symbol}, neighbours_dict::OrderedDict{Symbol, Neighbours})
...
"""
function repair_bad_channels!(data::ContinuousData, bad_channels::Vector{Symbol}, neighbours_dict::OrderedDict{Symbol, Neighbours})
...
function repair_channels_spherical_spline!(
    ...
    for i in 1:n_good, j in 1:n_good
