...
function _cleanline_channel!(
    ...
    f0::Vector{Float64},
    fscanbw::Float64,
    sig_threshold::Float64,
    freqs::AbstractVector{Float64},
    H0::Vector{Float64},
    H0sq::Float64,
    Kodd::StepRange{Int,Int},
    Keven::StepRange{Int,Int},
    plan,
    buf::CleanLineThreadBuffer,
)
    N = length(data)
...
function _cleanline_ftestc_fit!(
    buf::CleanLineThreadBuffer,
    datawin::AbstractVector{Float64},
    tapers::Matrix{Float64},
    Fs::Float64,
    f0::Vector{Float64},
    fscanbw::Float64,
