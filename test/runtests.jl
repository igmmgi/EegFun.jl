...
@testset "EegFun" begin
    ...
    include("tests/condition_average_tf.jl")
    include("tests/condition_difference_tf.jl")
    include("tests/channel_average_tf.jl")
    include("tests/channel_difference_tf.jl")
