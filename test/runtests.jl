...
@testset "eegfun" begin
    ...
    # include("test_batch_filter.jl")
    # include("test_batch_average_epochs.jl")
    # include("test_batch_channel_summary.jl")
    # include("test_batch_combine_channels.jl")
    # include("test_batch_combine_conditions.jl")
    # include("test_batch_difference_conditions.jl")
    include("test_batch_erp_measurements.jl")
    # include("test_batch_grandaverage.jl")
    # include("test_batch_rereference.jl")
    # include("test_batch_utils.jl")
end
