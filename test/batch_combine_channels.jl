...
@testset "Batch Combine Channels" begin
    ...
    try
        ...
        @testset "Basic channel combining" begin
            ...
            result = eegfun.combine_channels("erps_cleaned",
                                            [eegfun.channels([:Fp1, :Fp2]),
                                             eegfun.channels([:PO7, :PO8])],
                                            input_dir = test_dir,
        ...
        @testset "Error handling" begin
            ...
            @test_throws Exception eegfun.combine_channels("erps_cleaned",
                                                          [eegfun.channels([:Fp1, :Fp2])],
        ...
        @testset "Logging" begin
            ...
            eegfun.combine_channels("erps_cleaned",
                                   [eegfun.channels([:Fp1, :Fp2])],
                                   input_dir = test_dir,
                                   output_dir = output_dir)
        ...
        @testset "Combining math correctness" begin
            ...
            layout = eegfun.Layout(
                DataFrame(label = [:Ch1, :Ch2], inc = [0.0, 0.0], azi = [0.0, 0.0]),
                nothing, nothing
            )
            ...
            eegfun.combine_channels("erps_math",
        ...
        @testset "Pattern matching variants" begin
            ...
            result1 = eegfun.combine_channels("erps_original",
                                             [eegfun.channels([:Fp1, :Fp2])],
            ...
            result2 = eegfun.combine_channels("erps",
                                             [eegfun.channels([:Fp1, :Fp2])],
                                             input_dir = pattern_dir,
        ...
        @testset "EpochData support" begin
            ...
            result = eegfun.combine_channels("epochs",
                                            [eegfun.channels([:Fp1, :Fp2])],
                                            output_labels = [:frontal],
        ...
        @testset "Invalid channel selection" begin
            ...
            result = eegfun.combine_channels("erps",
        ...
        @testset "All channels combined" begin
            ...
            original_erps = load(joinpath(test_dir, "1_erps_cleaned.jld2"), "erps")
            all_ch_data = hcat(original_erps[1].data.Fp1, original_erps[1].data.Fp2,
                              original_erps[1].data.PO7, original_erps[1].data.PO8,
                              original_erps[1].data.Fz, original_erps[1].data.Cz,
        ...
        @testset "Many channels" begin
            ...
            layout = eegfun.Layout(
                DataFrame(label = channel_names, inc = zeros(20), azi = zeros(20)),
                nothing, nothing
            )
            ...
            result = eegfun.combine_channels("erps_many",
