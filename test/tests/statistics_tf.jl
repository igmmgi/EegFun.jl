...
@testset "TF Statistics" begin
    ...
    @testset "plot_tf_stats - invalid arguments" begin
        ...
        @test_throws ErrorException EegFun.plot_tf_stats(result; content = :invalid, display_plot = false)
        @test_throws ErrorException EegFun.plot_tf_stats(result; significance = :invalid, display_plot = false)
    end
