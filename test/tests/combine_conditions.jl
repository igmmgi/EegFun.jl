...
@testset "Batch Combine Conditions" begin
    ...
    try
        ...
        @testset "Basic condition combining" begin
            ...
            result = eegfun.combine_conditions("epochs_cleaned", 
                                             [[1, 2], [3, 4]],
                                             input_dir = test_dir,
        ...
        @testset "Error handling" begin
            ...
            @test_throws Exception eegfun.combine_conditions("epochs_cleaned", 
                                                           [[1, 2]], 
                                                           input_dir = "/nonexistent/path")
            
            # Invalid pattern (doesn't contain 'epochs')
            @test_throws Exception eegfun.combine_conditions("erps_cleaned", 
                                                           [[1, 2]],
                                                           input_dir = test_dir)
        ...
        @testset "Data integrity - concatenation preserves all epochs" begin
            ...
            eegfun.combine_conditions("epochs_cleaned", 
                                    [[1, 2], [3, 4]],
                                    input_dir = test_dir,
                                    output_dir = output_dir)
        ...
        @testset "Different epoch counts per condition" begin
            ...
            result = eegfun.combine_conditions("epochs_var", 
                                             [[1, 2]],
                                             input_dir = var_dir,
                                             output_dir = output_dir)
        ...
        @testset "Non-integer condition groups" begin
            ...
            @test_throws MethodError eegfun.combine_conditions("epochs_cleaned", 
                                                             [["1", "2"], [3, 4]],
                                                             input_dir = test_dir,
                                                             output_dir = output_dir)
        end
        ...
        @testset "File corruption handling" begin
            ...
            result = eegfun.combine_conditions("epochs_corrupt", 
                                             [[1, 2]],
        ...
        @testset "Missing epochs variable" begin
            ...
            result = eegfun.combine_conditions("epochs_missing", 
                                             [[1, 2]],
        ...
        @testset "Empty epochs data" begin
            ...
            result = eegfun.combine_conditions("epochs_empty", 
                                             [[1, 2]],
        ...
        @testset "Inconsistent sample rates across conditions" begin
            ...
            result = eegfun.combine_conditions("epochs_inconsistent", 
                                             [[1, 2]],
        ...
        @testset "Inconsistent layouts across conditions" begin
            ...
            layout1 = eegfun.Layout(
                DataFrame(label = [:Fz], inc = [0.0], azi = [0.0]),
                nothing, nothing
            )
            layout2 = eegfun.Layout(
            ...
            result = eegfun.combine_conditions("epochs_inconsistent_layout", 
                                             [[1, 2]],
        ...
        @testset "Memory usage with large datasets" begin
            ...
            output_dir = joinpath(test_dir, "combined_large")
            result = eegfun.combine_conditions("epochs_large", 
                                             [[1, 2]],
                                             input_dir = large_dir,
                                             output_dir = output_dir)
        ...
        @testset "Many channels" begin
            ...
            result = eegfun.combine_conditions("epochs_many", 
                                             [[1, 2]],
