...
@testset "Batch ERP Measurements" begin
    ...
    @testset "Edge cases" begin
        ...
        @testset "Empty baseline window" begin
            ...
            result = EegFun.erp_measurements(
                ...
                "mean_amplitude",
                analysis_interval = (0.1, 0.2),
                baseline_interval = (10.0, 11.0),  # No samples in this range
                input_dir = test_dir,
                output_dir = output_dir,
            )
        ...
        @testset "Single sample analysis window" begin
            ...
            result = EegFun.erp_measurements(
                "erps_single",
                "mean_amplitude",
                analysis_interval = (0.1, 0.1001),  # Very narrow window
                input_dir = test_dir,
                output_dir = output_dir,
            )
    ...
    @testset "Known value validation" begin
        ...
        function create_known_signal_erp(
            participant::Int,
            condition::Int,
        ...
        @testset "Area measurements" begin
            ...
            result = EegFun.erp_measurements(
                "area_test",
                "rectified_area",
                analysis_interval = (t_start, t_end),
                input_dir = known_test_dir,
