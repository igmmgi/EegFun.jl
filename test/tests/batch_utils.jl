...
@testset "Batch Utils" begin
    ...
    @testset "_select_conditions" begin
        # Create test data
        data = [create_test_erp_data(1, i) for i in 1:5]
    ...
    @testset "Edge cases and error handling" begin
        ...
        @testset "Batch operation edge cases" begin
            ...
            results = eegfun._run_batch_operation((x, y) -> eegfun.BatchResult(true, "test", "ok"), 
            ...
            results = eegfun._run_batch_operation(process_fn_nothing, 
                                                ["test_1.jld2"], test_dir, test_dir)
