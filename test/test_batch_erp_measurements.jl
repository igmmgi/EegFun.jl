"""
Test suite for src/analysis/batch/erp_measurements.jl
"""
...
@testset "Batch ERP Measurements" begin
    ...
    @testset "Basic ERP measurements" begin
        ...
        result = eegfun.erp_measurements("erps_cleaned", (0.1, 0.2), "mean_amp",
                                       input_dir = test_dir,
    ...
    @testset "Different analysis types" begin
        ...
        for analysis_type in ["max_peak", "min_peak", "max_peak_lat", "min_peak_lat"]
            result = eegfun.erp_measurements("erps_cleaned", (0.1, 0.2), analysis_type,
                                           input_dir = test_dir,
                                           output_dir = output_dir)
    ...
    @testset "Epoch data processing" begin
        ...
        result = eegfun.erp_measurements("epochs_cleaned", (0.1, 0.2), "mean_amp",
                                       input_dir = test_dir,
                                       output_dir = output_dir)
    ...
    @testset "Baseline correction" begin
        ...
        result_no_baseline = eegfun.erp_measurements("erps_cleaned", (0.1, 0.2), "mean_amp",
                                                   input_dir = test_dir,
                                                   output_dir = output_dir)
    ...
    @testset "Error handling" begin
        @testset "Invalid input directory" begin
            @test_throws Exception eegfun.erp_measurements("erps_cleaned", (0.1, 0.2), "mean_amp",
                                                         input_dir = "/nonexistent/dir")
        end
        
        @testset "Invalid analysis type" begin
            @test_throws Exception eegfun.erp_measurements("erps_cleaned", (0.1, 0.2), "invalid_type",
                                                         input_dir = test_dir)
        end
        
        @testset "Invalid analysis window" begin
            @test_throws Exception eegfun.erp_measurements("erps_cleaned", (0.2, 0.1), "mean_amp",
                                                         input_dir = test_dir)
        end
        ...
        @testset "Analysis window outside data range" begin
            ...
            result = eegfun.erp_measurements("erps_cleaned", (2.0, 3.0), "mean_amp",
                                           input_dir = test_dir,
                                           output_dir = output_dir)
    ...
    @testset "Edge cases" begin
        @testset "No matching files" begin
            ...
            result = eegfun.erp_measurements("nonexistent_pattern", (0.1, 0.2), "mean_amp",
                                           input_dir = test_dir,
                                           output_dir = output_dir)
