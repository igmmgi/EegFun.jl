...
bad_epochs_automatic = eegfun.detect_bad_epochs_automatic(epochs[1], abs_criterion = 200);
bad_epochs_automatic = eegfun.detect_bad_epochs_automatic(epochs[1], z_criterion = 3.0);
bad_epochs_automatic = eegfun.detect_bad_epochs_automatic(epochs[1], z_criterion = 3.0, abs_criterion = 200);
