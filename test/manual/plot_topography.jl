...
eegfun.plot_topography(dat, colorbar_label_fontsize=30)
eegfun.plot_topography(dat, colorbar_tick_fontsize=30)
...
eegfun.plot_topography(epochs[1], gridscale = 50)
eegfun.plot_topography(epochs[2], gridscale = 1000)
eegfun.plot_topography(epochs[1], colormap = :inferno)
eegfun.plot_topography(epochs[2], title = "Custom Title", title_fontsize = 30)
eegfun.plot_topography(epochs[1], sample_selection = x -> x.time .>= 0.4 .&& x.time .<= 0.6)
eegfun.plot_topography(epochs[2], channel_selection = eegfun.channels([:Fp1, :Fp2, :Cz]))
eegfun.plot_topography(epochs[1], label_fontsize=30)
eegfun.plot_topography(epochs[2], point_markersize=30, point_marker=:x)
eegfun.plot_topography(epochs[1], ylim = (-10, 10))
eegfun.plot_topography(epochs[2], ylim = (-1, 1))
eegfun.plot_topography(epochs[1], colorbar_label_fontsize=30)
eegfun.plot_topography(epochs[2], colorbar_tick_fontsize=30)
