...
@testset "channel_difference" begin
    ...
    dat_ab = copy(dat)
    eegfun.channel_difference!(dat_ab; channel_selection1 = eegfun.channels([:A]), channel_selection2 = eegfun.channels([:B]), channel_out = :AB)
    dat_ba = copy(dat)
    eegfun.channel_difference!(dat_ba; channel_selection1 = eegfun.channels([:B]), channel_selection2 = eegfun.channels([:A]), channel_out = :BA)
    ...
    dat_layout = copy(dat)
    eegfun.channel_difference!(dat_layout; channel_selection1 = eegfun.channels([:A]), channel_selection2 = eegfun.channels([:B]), channel_out = :tmp)
    ...
    dat_orig = copy(dat)
    dat_new = eegfun.channel_difference(dat_orig; channel_selection1 = eegfun.channels([:A]), channel_selection2 = eegfun.channels([:B]), channel_out = :A_minus_B2)
