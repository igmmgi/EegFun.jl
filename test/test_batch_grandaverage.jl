"""
Test suite for src/analysis/batch/grandaverage.jl
"""
...
@testset "Batch Grand Average" begin
    ...
    @testset "Basic grand averaging" begin
        ...
        result = eegfun.grandaverage("erps_cleaned",
                                   input_dir = test_dir,
    ...
    @testset "Error handling" begin
        @testset "Invalid input directory" begin
            @test_throws Exception eegfun.grandaverage("erps_cleaned",
                                                     input_dir = "/nonexistent/dir")
        end
        
        @testset "Non-ERP pattern" begin
            @test_throws Exception eegfun.grandaverage("epochs_cleaned",
                                                     input_dir = test_dir)
        end
        
        @testset "No matching files" begin
            @test_throws Exception eegfun.grandaverage("nonexistent_pattern",
                                                     input_dir = test_dir)
        end
