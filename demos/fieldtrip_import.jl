...
continuous_data = EegFun.load_fieldtrip("./resources/data/fieldtrip/continuous.mat", layout)
EegFun.trigger_count(continuous_data)
EegFun.plot_databrowser(continuous_data)

# Load epoched data  
println("\nLoading epoched data...")
epoch_data = EegFun.load_fieldtrip("./resources/data/fieldtrip/epochs.mat", layout)
EegFun.plot_databrowser(epoch_data)

# Load ERP data
println("\nLoading ERP data...")
erp_data = EegFun.load_fieldtrip("./resources/data/fieldtrip/erp.mat", layout)
...
println("\nLoading ERP data...")
epoch_data = EegFun.load_fieldtrip("./resources/data/fieldtrip/custom_epochs.mat", layout)

# Load ERP data
println("\nLoading ERP data...")
erp_data = EegFun.load_fieldtrip("./resources/data/fieldtrip/custom_erp.mat", layout)
