...
## Why Use ICA for EEG? {#Why-Use-ICA-for-EEG?}
...
## Identifying Artifact Components {#Identifying-Artifact-Components}

### EOG (Eye Movement) Components {#EOG-Eye-Movement-Components}
...
### ECG (Cardiac) Components {#ECG-Cardiac-Components}
...
### When NOT to Use ICA {#When-NOT-to-Use-ICA}
...
## Component Rejection vs. Artifact Correction {#Component-Rejection-vs.-Artifact-Correction}
> 
