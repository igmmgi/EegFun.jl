...
# Channel Metrics Demo {#Channel-Metrics-Demo}

Demonstrates computing channel quality metrics including joint probability and EOG correlation.

## Overview {#Overview}

Shows how to calculate channel quality metrics for artifact detection. Includes extreme value detection, channel joint probability, EOG channel creation and correlation analysis, and partitioning channels by EOG correlation.
