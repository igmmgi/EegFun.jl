...
# Channel Repair Demo {#Channel-Repair-Demo}

Demonstrates interpolation methods for repairing bad channels.

## Overview {#Overview}

Shows two methods for interpolating bad channels: neighbor interpolation (average of spatial neighbors) and spherical spline interpolation (more sophisticated spatial interpolation).
