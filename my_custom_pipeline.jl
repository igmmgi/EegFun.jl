...
using EegFun
"""
    custom_preprocess(config::String; log_level::String = "info")
...
"""
function custom_preprocess(config::String; log_level::String = "info")

    # Set up the global log for overall processing
    global_log = setup_global_logging("custom_preprocess.log", log_level = log_level)
...
# 3. Run with: custom_preprocess("your_config.toml", log_level = "info")
