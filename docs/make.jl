...
pages = [
    ...
    "How-to Guides" => [
        ...
        "Teaching Demos" => [
            "Signal Example (Sampling)" => "demos/teaching/signal_processing/signal_example_sampling.md",
            "Signal Example (Composition)" => "demos/teaching/signal_processing/signal_example_composition.md",
            "Signal Example (Dot Product)" => "demos/teaching/signal_processing/signal_example_dotproduct.md",
            "Signal Example (Convolution)" => "demos/teaching/signal_processing/signal_example_convolution.md",
            "Signal Example (Spectrum)" => "demos/teaching/signal_processing/signal_example_spectrum.md",
            "Signal Example (Time-Frequency)" => "demos/teaching/signal_processing/signal_example_tf.md",
            "Signal Example (Decoding)" => "demos/teaching/machine_learning/signal_example_decoding.md",
            "Simulate ERP" => "demos/teaching/erp/simulate_erp.md",
            "ICA 0: Matrix Math (U = WX)" => "demos/teaching/ica/signal_example_ica_0.md",
            "ICA 1: What Is a Mixture?" => "demos/teaching/ica/signal_example_ica_1.md",
            "ICA 2: Mixing & Unmixing" => "demos/teaching/ica/signal_example_ica_2.md",
            "ICA 3: Blind Source Separation" => "demos/teaching/ica/signal_example_ica_3.md",
            "ICA: The Central Limit Theorem" => "demos/teaching/ica/signal_example_ica_clt.md",
            "ICA 4: Sphering (Whitening)" => "demos/teaching/ica/signal_example_ica_4.md",
            "ICA 5: Inside the Black Box" => "demos/teaching/ica/signal_example_ica_5.md",
            "ICA 6: Infomax (Information Theory)" => "demos/teaching/ica/signal_example_ica_infomax.md",
        ],
