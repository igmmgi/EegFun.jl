...
- [Simulate ERP](../erp/simulate_erp.md) — how trial averaging extracts signals from noise
- [Signal Example — Composition](../signal_processing/signal_example_composition.md) — signal composition and filtering
- [Signal Example — Time-Frequency](../signal_processing/signal_example_tf.md) — time-frequency analysis methods
