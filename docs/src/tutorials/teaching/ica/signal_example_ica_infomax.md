# Signal Example — ICA 6: Infomax (Information Theory)
...
Because the "Sphering" process in Part 4 locks our data into a geometrically round matrix, the total Joint Entropy $H(y_1, y_2)$ technically becomes a constant. 
