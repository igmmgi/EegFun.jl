...
![Paradigm figure showing trial sequence: fixation cross (800 ms), then face or body part stimulus (200 ms), then blank ITI (1000 ms)](../../public/demos/experiments/n170/n170_paradigm.png)
...
![Biosemi 72-channel layout](../../public/demos/experiments/n170/biosemi72.png)
...
![Databrowser showing vEOG channel with detected blink onsets highlighted](../../public/demos/experiments/n170/veog.png)
...
```julia
EegFun.lowpass_filter("erps_final", 30, input_dir = "./output_data")
```
...
EegFun.grand_average("erps_final",
    input_dir = "./output_data/filtered_erps_final_lp_30hz"
)
```
...
ga = EegFun.read_data(
    "./output_data/filtered_erps_final_lp_30hz/grand_average_erps_final/grand_average_erps_final.jld2"
)
...
![Grand average ERP waveforms at the N170 ROI (P7, P8, PO7, PO8)](../../public/demos/experiments/n170/n170_erp.png)
...
![Topographic map at the N170 time window (~170 ms)](../../public/demos/experiments/n170/n170_topo.png)
...
![Difference wave (Face − Body) at the N170 ROI](../../public/demos/experiments/n170/n170_erp_diff.png)
...
![Difference wave topography at ~170 ms](../../public/demos/experiments/n170/n170_topo_diff.png)
...
EegFun.plot_erp_measurement_gui("./output_data/filtered_erps_final_lp_30hz/example1_erps_final.jld2")
```

![ERP Measurement GUI](../../public/demos/experiments/n170/n170_measurement_erp.png)
...
![ERP cluster-based permutation test results](../../public/demos/experiments/n170/n170_erp_stats.png)
